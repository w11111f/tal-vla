...
if __name__ == '__main__':
    ...
    # print('\n\n')
    # print('//' * 20)
    # print('01. Without Order (w/ PCA, Partially selected)')
    ...
    # print('\n\n')
    # print('//' * 20)
    # print('02. Without MCAS (w/ PCA, Partially selected)')
    # print('pool_sets: [(5, 2), (10, 5), (15, 5), (20, 5), (20, 10), (30, 5), (30, 10)]')
    # print('//' * 20)
    #
    # for seed in seeds:
    ...
    #                                                 INIT_DATAPOINT=True)
    #
    # # * 03. Without EarlyStop
    # print('\n\n')
    # print('//' * 20)
    # print('03. Without EarlyStop (w/ PCA, All selected)')
    ...
    # print('\n\n')
    # print('//' * 20)
    # print('04. Without PCA (w/o PCA, Partially selected)')
    # print('pool_sets: [(5, 2), (10, 5), (15, 5), (20, 5), (20, 10), (30, 5), (30, 10)]')
    # print('//' * 20)
    #
    # for seed in seeds:
    ...
    print('\n\n')
    print('//' * 20)
    print('05. Without Aall (w/ PCA, Partially selected)')
    print('pool_sets: [(5, 2), (10, 5), (15, 5), (20, 5), (20, 10), (30, 5), (30, 10)]')
    print('//' * 20)
    ...
    for seed in seeds:
        ...
        test_policy_with_action_effect_features(config,
                                                ...
                                                STATE_FORMAT_GOAL=True,
                                                INIT_DATAPOINT=True,
                                                IGNORE_ACTION_MODEL=True)  # * w/o action model.
