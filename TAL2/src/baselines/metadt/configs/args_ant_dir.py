...
def get_args(rest_args=None):
    ...
    parser.add_argument('--env_name', default="AntDir-v0")
    ...
    parser.add_argument('--zero_shot', type=bool, default=False,
                        help='False for few_shot Meta-DT, True for zero_shot Meta-DT.')
    ...
    parser.add_argument('--state_dim', type=int, default=27)
    ...
    parser.add_argument('--warm_train', type=int, default=70000)
